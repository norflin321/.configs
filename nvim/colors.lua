...
vim.api.nvim_set_hl(0, "Conceal", { fg = red, bg = bg })
...
vim.api.nvim_set_hl(0, "Directory", { fg = red })
...
vim.api.nvim_set_hl(0, "Title", { fg = red, bold = true })
...
vim.api.nvim_set_hl(0, "Error", { fg = red, bg = bg, bold = true })
vim.api.nvim_set_hl(0, "ErrorMsg", { fg = red, bold = true })
vim.api.nvim_set_hl(0, "WarningMsg", { fg = red, bold = true })
vim.api.nvim_set_hl(0, "MoreMsg", { fg = primitive })
vim.api.nvim_set_hl(0, "Todo", { fg = red, bold = true })
...
vim.api.nvim_set_hl(0, "DiffDelete", { fg = fg, bg = keyword, bold = true })
vim.api.nvim_set_hl(0, "DiffText", { bg = primitive })
vim.api.nvim_set_hl(0, "QuickFixLine", { bg = bg_1 })
vim.api.nvim_set_hl(0, "htmlTag", { fg = bg_4 })
vim.api.nvim_set_hl(0, "htmlEndTag", { fg = bg_4 })
vim.api.nvim_set_hl(0, "htmlSpecialTagName", { fg = red })
...
vim.api.nvim_set_hl(0, "DiagnosticVirtualTextError", { fg = red, bg = bg_1 })
vim.api.nvim_set_hl(0, "DiagnosticUnderlineError", { fg = red, underline = true })
vim.api.nvim_set_hl(0, "DiagnosticWarn", { fg = red })
vim.api.nvim_set_hl(0, "DiagnosticVirtualTextWarn", { fg = red, bold = true })
vim.api.nvim_set_hl(0, "DiagnosticUnderlineWarn", { fg = red, underline = true })
...
vim.api.nvim_set_hl(0, "Float", { fg = primitive })
...
vim.api.nvim_set_hl(0, "@text.title", { fg = red, bold = true })
...
vim.api.nvim_set_hl(0, "@type", { fg = red })
vim.api.nvim_set_hl(0, "@type.builtin", { fg = red })
